...
public class ControllTables extends Inits {
    ...
    public static void initKurs() throws SQLException, ClassNotFoundException, ParseException {
        ...
        while(resSet.next())
        {
            ...
            Controller.kurs_Data.add(new SellBuy(w_date , curr , buy , sell));
        }
        ...
        try{
            ...
            WriteDB.run_add_new_date(new_date);
    ...
    public static void intiCredit() throws SQLException, ClassNotFoundException
    {
        ...
        while(resSet.next())
        {
            ...
            Controller.credit_Data.add(new CreditInfo(pas_seria,pas_nomer, pas_s , pas_n , pas_och , s , n , avr_mnth_cash , id , credit_id , cash_per_month));
