...
import sample.checkTable.CheckInfo;
import sample.custToGo.genData;
...
public class Controller extends Inits{
    ...
    public static ObservableList<SellBuy> kurs_Data = FXCollections.observableArrayList();
    public static ObservableList<CreditInfo> credit_Data = FXCollections.observableArrayList();


    @FXML
    private void initialize() throws SQLException, ClassNotFoundException, ParseException {

        ControllTables.initData();
        ...
        ControllTables.initKurs();
        date_column.setCellValueFactory(new PropertyValueFactory<SellBuy, String>("date"));
        curr_column.setCellValueFactory(new PropertyValueFactory<SellBuy, Integer>("curr"));
        buy_column.setCellValueFactory(new PropertyValueFactory<SellBuy, Double>("buy"));
        sell_column.setCellValueFactory(new PropertyValueFactory<SellBuy, Double>("sell"));
        kurs_table.setItems(kurs_Data);


        ControllTables.intiCredit();
        pas_seria2.setCellValueFactory(new PropertyValueFactory<CreditInfo, Integer>("pas_seria"));
        pas_nomer2.setCellValueFactory(new PropertyValueFactory<CreditInfo, Integer>("pas_nomer"));
        pas_s2.setCellValueFactory(new PropertyValueFactory<CreditInfo, String>("pas_s"));
        pas_n2.setCellValueFactory(new PropertyValueFactory<CreditInfo, String>("pas_n"));
        pas_och2.setCellValueFactory(new PropertyValueFactory<CreditInfo, String>("pas_och"));
        s.setCellValueFactory(new PropertyValueFactory<CreditInfo, Integer>("s"));
        n.setCellValueFactory(new PropertyValueFactory<CreditInfo, Integer>("n"));
        cash_per_month.setCellValueFactory(new PropertyValueFactory<CreditInfo, Double>("cash_per_month"));
        credit_id.setCellValueFactory(new PropertyValueFactory<CreditInfo, Integer>("credit_id"));
    ...
    public void onClick_ent() throws SQLException, ClassNotFoundException{
        ...
        try {
            ...
            Convert help = new Convert(temp_curr);
            curr = help.to_int();
            ...
            CheckInfo wat = new CheckInfo(pas_seria,pas_nomer);
            ...
            if (id != 0)//не новый клиент, уже есть в бд
            {
                ...
                WriteDB.run_new_check(cust_new);
    ...
    public void onClick_upt() throws SQLException, ClassNotFoundException {
        try {
            ...
            CheckInfo wat = new CheckInfo(pas_seria, pas_nomer, pas_s, pas_n, pas_och, check_num , curr);
            int k = wat.find_Info();
            ...
            Convert help1 = new Convert(curr_of_check);
    ...
    public void onClick_credit () throws SQLException, ClassNotFoundException
    {
        try {
            ...
            CreditInfo cust = new CreditInfo(s,n,avr_mnt_cash,id, credit_id , cash_per_month);
            WriteDB.run_add_credit(cust);
...
public void next_click() throws SQLException {
    ...
    genData cust_to_go = new genData();
    ...
    else if (desteny == 3)
    {
        ...
        CheckInfo help = new CheckInfo(Integer.parseInt(pas_seria_hi.getText()) , Integer.parseInt(pas_nomer_hi.getText()));
