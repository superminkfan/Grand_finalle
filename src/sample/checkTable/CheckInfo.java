package sample.checkTable;

import sample.dbWork.Conn;
...
public class CheckInfo {
    ...
    public CheckInfo(int pas_seria, int pas_nomer, String pas_s, String pas_n, String pas_och, int check_num, int curr) {
    ...
    public CheckInfo(int pas_seria, int pas_nomer)
    {
