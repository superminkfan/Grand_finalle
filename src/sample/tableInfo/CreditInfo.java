...
public class CreditInfo {
    ...
    public CreditInfo(int s, int n, int avr_mnt_cash, int id, int credit_id , double cash_per_month) {
        this.s = s;
        this.n = n;
    ...
    public CreditInfo(int pas_seria, int pas_nomer, String pas_s, String pas_n, String pas_och, int s, int n, int avr_mnt_cash, int id, int credit_id , double cash_per_month) {
